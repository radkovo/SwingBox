...
//    protected Map<String, String> elementAttributes;
    ...
    /**
     * Instantiates a new text based view, able to display rich text.
     * This view corresponds to TextBox in CSSBox.
     * <br><a href="http://www.w3.org/TR/CSS21/box.html">Box Model</a>
     *
     * @param elem
     *            the elem
     *
	...
	//assume that attributes has changed, reflect changes immediately
     ...
     *
     * @return true, if is visible {@inheritDoc}
     */
    @Override
	...
	TextHitInfo hit = ((b == Position.Bias.Forward) ?
	...
	alloc.setRect(alloc.getX() + locs[0], alloc.getY(), 1D, alloc.getHeight());
...
//	TextHitInfo hit = layout.hitTestChar(x - box.getAbsoluteContentX(), 0f);
	...
	if (c instanceof JTextComponent) {
		...
		((LayeredHighlighter)highLighter).paintLayeredHighlights
		(g, p0, p1, box.getAbsoluteBounds(), tc, this);
//		(g, p0, p1, a, tc, this);
	    }
...
//	    }
	...
	/*
	 * text decoration - none, underline, overline, strikethrough, blink, (inherit ?)
	...
	if( p0 > pStart || p1 < pEnd ) {
		...
		Shape s = modelToView(p0, Position.Bias.Forward,
...
//     */
//    protected void setTextDecoration(TextDecoration newTextDecoration) {
//	setTextDecoration(textDecoration.toString());
//    }
...
//	    }
     ...
     */
    public static final Rectangle intersection(Rectangle src1, Rectangle src2, Rectangle dest) {
